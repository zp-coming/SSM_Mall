...
import com.zp.mall.service.GoodsService;
...
//    @RequestMapping("/list")
//    public void list(@RequestParam(required = false, defaultValue = "1") int pageNO, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
//        int size = 5;
//        request.setAttribute("size", size);
//        request.setAttribute("pageNO", pageNO);
//        request.setAttribute("count", goodsService.getGoodsCount());
//        request.setAttribute("goods", goodsService.getGoodsPager(pageNO, size));
//
